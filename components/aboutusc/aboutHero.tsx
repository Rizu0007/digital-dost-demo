      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="py-20 lg:py-24">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <div className="mb-8 inline-flex items-center space-x-2 rounded-full bg-[#00729f] px-4 py-2">
            ...
            <div className="mt-8">
        <button className="px-12 py-4 bg-[#00729f] hover:bg-primary text-white text-lg font-medium rounded-full  transition duration-300">
         Book Meeting
        </button>
      </div>          </div>
        </div>
