export const servicedata = [
  {
    ...
    services: [
      {
        mainheading: "Our Company’s Digital Marketing Services",
      },
      {
    ...
    advantages: [
      {
        ...
        title: "How Does a Digital Marketing Agency Help to Grow Your Business?",
...

  {
    ...
    services: [
      {
        mainheading: "Our Company’s Branding Services",
      },
      {
  ...
  //written by us
  {
    ...
    flow: [
      ...
      },
      {
        ...
        description: "We begin by understanding your business goals, target audience, and specific requirements. This helps us define the scope, features, and functionality needed for your website.",
      },
      {
        number: "02",
        title: "Design & Wireframing",
        description:"Our team creates wireframes and visual designs that align with your brand identity, focusing on user experience and responsiveness across devices.",
      },
      {
        number: "03",
        title: "Development",
        description:"In this phase, we turn the design into a fully functional website using the latest technologies. This includes coding, creating interactive elements, and ensuring cross-browser compatibility.",
      },
      {
        number: "04",
        title: "Content Integration",
        description:"We add and optimize content for SEO, ensuring your website is informative and engaging while adhering to search engine best practices.",
      },
      {
        number: "05",
        title: "Testing & Quality Assurance",
        description:"Rigorous testing is conducted to ensure the website performs flawlessly on all devices and browsers, with no bugs or glitches.",
      },
      {
        number: "06",
        title: "Launch & Deployment",
        description:"After final approval, we launch the website on the desired platform, ensuring a smooth transition from development to live environment.",
      },
      {
        number: "07",
        title: "Ongoing Support & Maintenance",
        description:"Post-launch, we offer ongoing support and maintenance to keep your website secure, up-to-date, and optimized for performance.",
      },
    ],
  },
];
